...
# The Sinas post-upload registration path was removed: Grove is the
# system of record and every route registers via
# app.services.document_registry (content-hash + source identity).
# The old path keyed identity on collection_file_id and bypassed dedup.
